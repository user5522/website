...
<div class="${"pt-28 bg-black"}"><div class="${"flex flex-col p-10 items-center justify-center pb-20"}"><div class="${"flex flex-row"}"><p class="${"text-4xl"}">Projects</p></div>
    <div class="${"flex flex-row gap-1 "}"><div class="${"inline-block"}">Some projects I made/working on that I want to share with you
        <img src="${"/flushed.svg"}" alt="${"flushed emote"}" class="${"h-7"}"></div></div></div>
...
//# sourceMappingURL=_page.svelte-NBSIUDZP.js.map
