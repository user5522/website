...
<div class="fixed top-0 z-50 w-screen p-3">
	<nav class="flex flex-row items-center p-5 rounded-xl bg-dark">
		<div class="flex flex-row items-center gap-2 duration-300" id="logo">
			...
			>
				<img src="/Logo-flat.svg" class="items-center h-10 rounded-full bg-dark_light" alt="logo" />
			</M.div>
			<button
				href="/"
				id="logo_text"
				class="p-3 text-xl font-semibold duration-100 rounded-lg hover:bg-dark_light hover:scale-110 active:scale-90"
				alt="logo"
			>
				User5522
			</button>
