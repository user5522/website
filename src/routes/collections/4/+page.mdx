...
description: "After lots and lots of messing around & thanks to Clembs' invaluable assistance, collections now utilize .mdx files for a user-friendly experience."
date: '2023-01-10'
...
_Thanks [Clembs](https://clembs.com) again.. for the brilliant idea (&& the help)._
...
2 - Create a file named `+page.mdx` inside that folder
