		...
		<div class="grid gap-5 px-5 sm:grid-cols-2 2xl:grid-cols-4">
					...
					<div class="h-full w-full">
						...
						<div class="p-5 sm:h-1/3">
							...
							<div id="post_description" class="text-lg">
								Some screenshots from the Clembs Minecraft SMP winter early access, thought I would
			...
			>
				<div>
					<div class="h-full">
						<div id="post_img" class="flex justify-center sm:h-2/3">
							<img src="/collections/initial-release.png" alt="Initial release banner" />
						</div>
						<div class="sm:h-1/3">
							<div
								id="post_title"
							...
							<div id="post_description" class="text-lg">
								Finally, after lots of work, user5522.tk is now at version 1.0.0. This post talks
