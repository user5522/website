...
<div class="p-10">
  <div id="cards-container" class="grid gap-5 sm:grid-cols-2">
    <div
    ...
    >
      ...
      <div id="post_description" class="text-lg">
        This is a description about this post's content, it is supposed to be a
        summary for people to know what they will be reading.
      </div>
    </div>
    <div
      class="rounded-xl bg-dark p-5 text-white duration-200 hover:scale-105 active:scale-95"
