...
const error_template = ({ status, message }) => `<script>\r
	import { page } from '$app/stores';\r
	import { onMount } from 'svelte';\r
\r
	onMount(() => {\r
		document.getElementById('pathname').innerHTML = window.location.pathname;\r
	});\r
<\/script>\r
\r
<svelte:head>\r
	<title>{$page.error.message}</title>\r
</svelte:head>\r
\r
<div class="flex flex-col items-center justify-center gap-5 p-5">\r
	<div class="flex flex-col items-center justify-center gap-1">\r
		<div class="text-4xl font-semibold">\r
			{$page.status}: {$page.error.message}\r
		</div>\r
		<div class="text-3xl" id="pathname" />\r
	</div>\r
	<div>\r
		<div class="text-2xl">This looks like an error.. & that's unfortunate.</div>\r
		<div class="flex flex-col gap-5">\r
			<div class="flex justify-center text-2xl">Maybe try one of these solutions:</div>\r
			<div class="rounded-xl bg-dark p-3 text-lg duration-200 hover:scale-102 active:scale-95">\r
				<li>- Checking if the URL/Link you received exists</li>\r
				<li>- Taking a quick sip of water</li>\r
				<li>- Looking over for any typos in the URL</li>\r
				<li>\r
					- <a\r
						href="https://google.com/search?q=have+you+tried+turning+it+off+and+on+again"\r
						target="_blank"\r
						rel="noreferrer">Turning it off & on again?</a\r
					>\r
				</li>\r
			</div>\r
			<div class="flex justify-center text-xl">If none of these solutions work:</div>\r
		</div>\r
	</div>\r
	<div class="flex flex-row gap-5">\r
		<a href="/">\r
			<button class="blue-button">Return to homepage</button>\r
		</a>\r
		<a href="/about#Links">\r
			<button class="blue-button">Contact me</button>\r
		</a>\r
	</div>\r
</div>\r
<div\r
	class="absolute top-0 right-0 -z-20 rotate-180 text-8xl font-semibold text-white opacity-30 sm:text-9xl"\r
>\r
	Damn.\r
</div>\r
`;
