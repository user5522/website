...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_page();
  return `${$page.error || layoutExcl.some((item) => $page.route.id == item.id) ? `${slots.default ? slots.default({}) : ``}` : `<div class="${"bg-white"}">${validate_component(Navbar, "Navbar").$$render($$result, {}, {}, {})}
