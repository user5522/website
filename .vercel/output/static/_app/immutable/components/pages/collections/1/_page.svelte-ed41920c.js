import{S as Ft,i as Lt,s as Ut,a as b,k as s,q as l,w as Xt,R as Yt,h as n,c as v,l as a,m as c,r as i,x as Kt,n as o,K as Mt,b as Ct,E as t,y as Pt,B as Ht,f as Jt,t as Qt,z as Zt}from"../../../../chunks/index-9e7002bf.js";import{A as te}from"../../../../chunks/A2764-69d94bf6.js";function ee(zt){let E,y,p,g,d,R,q,C,j,z,F,w,h,_,jt,L,V,U,X,x,B,Y,K,e,M,D,P,H,J,Q,Z,tt,et,rt,O,st,at,ot,I,lt,it,nt,k,ct,ut,dt,f,ht,ft,mt,bt,A,vt,pt,gt,wt,yt,_t,xt,It,kt,m,Et,S;return k=new te({props:{class:"inline-block h-6 w-6"}}),{c(){E=b(),y=s("div"),p=s("div"),g=s("div"),d=s("div"),R=s("div"),q=l("#1"),C=b(),j=s("div"),z=l("Initial Release!"),F=b(),w=s("div"),h=s("div"),_=s("img"),L=b(),V=s("div"),U=l("Author: User5522"),X=b(),x=s("div"),B=s("div"),Y=l("On: 26/11/2022"),K=b(),e=s("div"),M=l(`Finally! After what felt like, forever, I'm proud to announce user5522.tk reached it's initial\r
			release, `),D=s("strong"),P=l("v1.0.0"),H=l("! "),J=s("br"),Q=l(`\r
			...
			It is mainly because I `),Kt(k.$$.fragment,r),ct=i(r,` Open-Source & to allow anyone who\r
